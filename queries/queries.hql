# Group 1 ex 1
drop table if exists group1_ex1;
create table group1_ex1 as
...
# Group 1 ex 2
drop table if exists group1_ex2;
create table group1_ex2 as
...
# Group 1 ex 3
drop table if exists table group1_ex3;
create table group1_ex3 as
...
select
    ...
    ROW_NUMBER() over (partition by xy.x, xy.y, yz.z, xy.date order by xy.delay + yz.delay asc) as rank
from
    flights_xy as xy,
    flights_yz as yz
